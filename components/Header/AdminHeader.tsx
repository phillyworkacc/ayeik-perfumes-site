...
export default function AdminHeader () {
   ...
   const adminHeaderLinks = [
      ...
      { href: "/admin/all-orders", label: "All Orders" },
      { href: "/admin/all-products", label: "All Products" },
      { href: "/admin/all-collections", label: "All Collections" },
   ]
               ...
               {websiteConfig.header.desktopNavStyle == "left" ? (<>
                  <div className="box full dfb align-center">
                     <div className="box full dfb align-center gap-20">
                        <div className="box fit dfb align-center cursor-pointer" onClick={() => router.push("/admin")}><Logo size={50} /></div>
                        {adminHeaderLinks.map((link, index) => (
                  ...
                  <div className="box full dfb align-center">
                     <div className="box fit dfb align-center cursor-pointer" onClick={() => router.push("/admin")}>
                        <Logo size={50} />
                     </div>
